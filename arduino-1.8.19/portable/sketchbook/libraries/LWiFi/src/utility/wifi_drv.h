...
class WiFiDrv
{
	...
	public:
		...
		static int8_t wifiSetNetwork_5G(const char* ssid, uint8_t ssid_len);
		...
		static int8_t wifiSetPassphrase_5G(const char* ssid, uint8_t ssid_len, const char *passphrase, const uint8_t len);
		...
		static int8_t wifiSetKey_5G(const char* ssid, uint8_t ssid_len, uint8_t key_idx, const char *key, const uint8_t len);
		...
		static int8_t startScanNetworks_5G();
