...
int8_t WiFiDrv::wifiSetNetwork_5G(const char* ssid, uint8_t ssid_len)
{
	return set_net_5G(ssid, ssid_len);
}
...
int8_t WiFiDrv::wifiSetPassphrase_5G(const char* ssid, uint8_t ssid_len, const char *passphrase, const uint8_t len)
{
	return set_passphrase_5G(ssid, ssid_len, passphrase, len);
}
...
int8_t WiFiDrv::wifiSetKey_5G(const char* ssid, uint8_t ssid_len, uint8_t key_idx, const char *key, const uint8_t len)
{
	return set_key_5G(ssid, ssid_len, key_idx, key, len);
}
...
int8_t WiFiDrv::startScanNetworks_5G()
{
	return start_scan_net_5G();
}
