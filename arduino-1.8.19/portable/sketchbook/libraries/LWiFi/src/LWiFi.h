...
public:
	...
	int begin_5G(const char* ssid, uint8_t key_idx, const char* key);
	...
	int begin_5G(const char* ssid, const char *passphrase);
...
public:
    ...
    bool softAP_5G(const char* ssid, const char* passphrase = NULL, int channel = 100);
    /*
