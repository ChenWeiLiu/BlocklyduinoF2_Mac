...
bool PMS::readUntil(DATA_PMS& data, uint16_t timeout)
{
  _data = &data;
    ...
    default:
      ...
      else if (_index == _frameLen + 2 + 1)
      {
        ...
        if (_calculatedChecksum == _checksum)
        {
          ...
          _data->temperature = makeWord(_payload[20], _payload[21])/10.0;
          _data->humidity = makeWord(_payload[22], _payload[23])/10.0;
        }
