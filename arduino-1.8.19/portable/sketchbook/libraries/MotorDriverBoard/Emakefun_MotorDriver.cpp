...
int Emakefun_EncoderMotor::getSpeed() {
    return (DcSpeed/16);
}
...
void Emakefun_StepperMotor::setSpeed(uint16_t rpm) {
  ...
  DcSpeed = 60000000 / ((uint32_t)revsteps * (uint32_t)rpm);
}

int Emakefun_StepperMotor::getSpeed() {
    return 60000000 / ((uint32_t)revsteps * DcSpeed);
}
