...
class Adafruit_PN532_linkit{
 public:
  Adafruit_PN532_linkit(uint8_t clk, uint8_t miso, uint8_t mosi, uint8_t ss);  // Software SPI
  Adafruit_PN532_linkit(uint8_t irq, uint8_t reset);  // Hardware I2C
  Adafruit_PN532_linkit(uint8_t ss);  // Hardware SPI
  void begin(void);
