...
#if defined (TFT_ON_I2SGO)
  #include <User_Setups/Setup25_I2S_GO.h>    // Setup file for ESP32 and TTGO T-Display ST7789V SPI bus TFT
#elif defined (TFT_ON_TTGO)
  #include <User_Setups/Setup25_TTGO_T_Display.h>    // Setup file for ESP32 and TTGO T-Display ST7789V SPI bus TFT
#elif defined (TFT_ON_KSB065)
  #include <User_Setups/Setup25_KSB065_Display.h>    // Setup file for ESP32 and TTGO T-Display ST7789V SPI bus TFT
#else
  #include <User_Setups/Setup25_USER_CUSTOM.h>    // Setup file for ESP32 and TTGO T-Display ST7789V SPI bus TFT 
#endif
