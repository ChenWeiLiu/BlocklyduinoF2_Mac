...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_END = "返回在列表中的指定位置的項目。#0 是最後一個項目。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_FROM_START = "返回在列表中的指定位置的項目。#0 是第一個項目。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_END = "移除並返回列表中的指定位置的項目。#0 是最後一個項目。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_GET_REMOVE_FROM_START = "移除並返回列表中的指定位置的項目。#0 是第一個項目。";
...
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_END = "移除在列表中的指定位置的項目。#0 是最後一個項目。";
Blockly.Msg.LISTS_GET_INDEX_TOOLTIP_REMOVE_FROM_START = "移除在列表中的指定位置的項目。#0 是第一個項目。";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_END = "插入在列表中的指定位置的項目。#0 是最後一個項目。";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_INSERT_FROM_START = "插入在列表中的指定位置的項目。#0 是第一個項目。";
...
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_END = "設定在列表中的指定位置的項目。#0 是最後一個項目。";
Blockly.Msg.LISTS_SET_INDEX_TOOLTIP_SET_FROM_START = "設定在列表中的指定位置的項目。#0 是第一個項目。";
...
Blockly.Msg["LISTS_INDEX_FROM_END_TOOLTIP"] = "%0 是最後一個項目。";
Blockly.Msg["LISTS_INDEX_FROM_START_TOOLTIP"] = "%0 是第一個項目。";
...
Blockly.Msg.BUTTON_UPLOAD_TITLE = "下載韌體";
Blockly.Msg.BUTTON_UPLOAD_STATE = "下載狀態";
Blockly.Msg.BUTTON_UPLOAD_START = "正在下載韌體直到顯示Finish...\n";
...
Blockly.Msg["DIALOG_ESP32_TITLE"] = "ESP32核心版本";
...
Blockly.Msg["BUTTON_WEBSERIAL"] = "開啟網頁序列埠監看視窗";

Blockly.Msg["MESSAGE_SHOWCODE"] = "即時顯示程式碼與置頂積木檢查功能啟用時較耗用系統資源，<br>當工作區積木較多時會造成拖曳積木緩慢。<br><br>解決方式：<br>1.縮合顯示程式碼區塊暫時停止即時顯示功能。<br>2.停用置頂積木檢查功能。";